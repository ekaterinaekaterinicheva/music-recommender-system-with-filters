...
from recommender import find_similar_tracks, search_songs
...
# Creating an endpoint/a route for the autocomplete search
@app.route("/search")
def search():
...
def recommend(): # Maps this function to the route '/recommendations'    
    ...
    recommended_tracks = filter_tracks(similar_tracks, popularity = popularity, gender = gender, region = region) # type: ignore
