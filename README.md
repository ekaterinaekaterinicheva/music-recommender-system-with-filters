...
This is a **content-based** music recommender system prototype with user-controlled **filters for fairness and diversity**
...
## Architecture of the music recommender system
...
```
Note: The latin-1 encoding and specific semi-colon (;) delimiters are required for these datasets to be parsed correctly due to the applied pre-processing.
